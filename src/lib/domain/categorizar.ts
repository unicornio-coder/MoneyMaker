...
import { detalleBasico, normalizar } from './texto';

// Reexportados por compatibilidad: viven en texto.ts para que los componentes de cliente no arrastren los catálogos.
export { detalleBasico, normalizar };
