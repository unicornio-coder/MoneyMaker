  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        modal: { from: { opacity: '0', transform: 'translate(var(--tw-translate-x, 0), calc(var(--tw-translate-y, 0) + 10px)) scale(.97)' }, to: { opacity: '1', transform: 'translate(var(--tw-translate-x, 0), var(--tw-translate-y, 0)) scale(1)' } },
        pop: { '0%': { opacity: '0', transform: 'scale(.5)' }, '70%': { opacity: '1', transform: 'scale(1.1)' }, '100%': { transform: 'scale(1)' } },
        'pulse-ring': { '0%': { transform: 'scale(.9)', opacity: '.55' }, '100%': { transform: 'scale(2.1)', opacity: '0' } },
        travel: { '0%': { transform: 'translateX(-10%)', opacity: '0' }, '15%': { opacity: '1' }, '85%': { opacity: '1' }, '100%': { transform: 'translateX(110%)', opacity: '0' } },
      ...
      animation: {
        ...
        modal: 'modal .28s cubic-bezier(.2,.8,.2,1) both',
        pop: 'pop .45s cubic-bezier(.2,.8,.2,1) both',
        'pulse-ring': 'pulse-ring 1.6s cubic-bezier(.2,.6,.3,1) infinite',
        travel: 'travel 1.4s cubic-bezier(.4,0,.2,1) infinite',
