  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        blob: { '0%, 100%': { transform: 'translate(0, 0) scale(1)' }, '33%': { transform: 'translate(40px, -30px) scale(1.12)' }, '66%': { transform: 'translate(-30px, 24px) scale(0.94)' } },
        'grow-x': { from: { transform: 'scaleX(0)' }, to: { transform: 'scaleX(1)' } },
        orbita: { from: { transform: 'rotate(0deg)' }, to: { transform: 'rotate(360deg)' } },
        'orbita-inversa': { from: { transform: 'translate(-50%, -50%) rotate(0deg)' }, to: { transform: 'translate(-50%, -50%) rotate(-360deg)' } },
      ...
      animation: {
        ...
        'grow-x': 'grow-x .6s cubic-bezier(.2,.8,.2,1) both',
        orbita: 'orbita 28s linear infinite',
        'orbita-inversa': 'orbita-inversa 28s linear infinite',
